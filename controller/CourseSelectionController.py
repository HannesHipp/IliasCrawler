...
class CourseSelectionController:
    ...
    def run():
        ...
        deleted_course_numbers = list(set(old_course_numbers) - set(current_course_numbers))
        ...
        new_course_numbers = list(set(current_course_numbers) - set(old_course_numbers))
        new_courses = []
        for course in current_courses:
